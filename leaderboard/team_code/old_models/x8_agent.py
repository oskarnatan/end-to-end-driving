...
from x8.config import GlobalConfig
from x8.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
class x8Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = x8(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
