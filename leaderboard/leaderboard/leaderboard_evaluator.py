...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        print("\033[1m> GANTI WEATHER\033[0m")
        # ClearNoon, ClearSunset, CloudyNoon, CloudySunset, WetNoon, WetSunset, MidRainyNoon, MidRainSunset, WetCloudyNoon, WetCloudySunset, HardRainNoon, HardRainSunset, SoftRainNoon, SoftRainSunset
        str_command = 'python3 '+os.getcwd()+'/utilx/environmentx.py --weather '+args.weather+' --host '+args.host+' --port '+args.port
        print(str_command)
        os.system(str_command) #eksekusi
        
        
        # print(os.getcwd())
        #CloudySunset
        # os.system('python3 /home/aisl/OSKAR/Transfuser/xtransfuser/utilx/environmentx.py --clouds 80 --rain 0 --wetness 30 --puddles 0 --wind 0.3499999940395355 --fog 0 -alt 15')
        #MidRainSunset
        # os.system('python3 /home/aisl/OSKAR/Transfuser/xtransfuser/utilx/environmentx.py --clouds 80 --rain 30 --wetness 0 --puddles 0 --wind 0.4000000059604645 --fog 0 -alt 15') 
