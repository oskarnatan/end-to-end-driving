...
def apply_weather_presets(args, weather):
    ...
    if args.weather is not None:
        if args.weather in WEATHERSX.keys():
            # print(weather)
            # print(WEATHERSX[args.weather])
            # weather = WEATHERSX[args.weather]
            weather.cloudiness = WEATHERSX[args.weather].cloudiness
            weather.precipitation = WEATHERSX[args.weather].precipitation
            weather.precipitation_deposits = WEATHERSX[args.weather].precipitation_deposits
            weather.wind_intensity = WEATHERSX[args.weather].wind_intensity
            weather.sun_azimuth_angle = WEATHERSX[args.weather].sun_azimuth_angle
            weather.sun_altitude_angle = WEATHERSX[args.weather].sun_altitude_angle
            weather.fog_density = WEATHERSX[args.weather].fog_density
            weather.fog_distance = WEATHERSX[args.weather].fog_distance
            weather.fog_falloff = WEATHERSX[args.weather].fog_falloff
            weather.wetness = WEATHERSX[args.weather].wetness
        else:
