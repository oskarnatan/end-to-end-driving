...
class GlobalConfig:
    ...
    n_class = 23
    batch_size = 1 #selalu 1 karena yang ini untuk inference
    ...
    lr = 1e-3 # learning rate #pakai AdamW
    weight_decay = 1e-2

    # Controller
    # control_option = 1 #1-one_of 2-both_must 3-pid_only 4-mlp_only 5-pid_def
    ...
    #LWS: lw_wp lw_str lw_thrt lw_brk saat convergence
    lws = [0.99754691123962, 1.0018420219421, 0.99990028142929, 0.999521970748901]
    # : [1, 1, 1, 1]
    # _w1 : [0.99754691123962, 1.0018420219421, 0.99990028142929, 0.999521970748901]
    # _t2 : [1, 1, 1, 1]
    # _t2w1 : [1, 1, 1, 1]
    ...
    min_act_thrt = 0.4 #minimum nilai suatu throttle dianggap aktif diinjak
