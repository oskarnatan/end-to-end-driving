...
class x9_B3(nn.Module): #
    ...
    def forward(self, rgb_f, depth_f, next_route, velo_in):#, gt_ss):
        ...
        hid_states = self.necks_net(self.flatten(RGB_features_sum+self.SC_encoder.avgpool(SC_features8))) #hid_state0)# cat([RGB_features_sum, SC_features8], dim=1)
