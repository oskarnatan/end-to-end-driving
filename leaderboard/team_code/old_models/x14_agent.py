...
from x14.config import GlobalConfig
from x14.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
class x14Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = x14(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
