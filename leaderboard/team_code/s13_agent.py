...
from s13.config import GlobalConfig
from s13.data import scale_and_crop_image, scale_and_crop_image_cv, swap_RGB2BGR #rgb_to_depth
...
class s13Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = s13(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
