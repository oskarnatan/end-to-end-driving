...
from x11.config import GlobalConfig
from x11.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
class x11Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = x11(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
