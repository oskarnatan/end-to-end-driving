...
from x8_R34.config import GlobalConfig
from x8_R34.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
class x8_R34Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = x8_R34(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
