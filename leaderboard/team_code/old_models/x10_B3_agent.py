...
from x10_B3.config import GlobalConfig
from x10_B3.data import scale_and_crop_image, scale_and_crop_image_cv, rgb_to_depth, swap_RGB2BGR
...
class x10_B3Agent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = x10_B3(self.config, torch.device("cuda:0")).float().to(torch.device("cuda:0"))
