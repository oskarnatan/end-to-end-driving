...
class GlobalConfig:
    ...
    lws = [0.998145520687103, 1.00085735321045, 0.999601662158966, 0.999582648277283]
    # : [1, 1, 1, 1]
    # _w1 : [0.998145520687103, 1.00085735321045, 0.999601662158966, 0.999582648277283]
    # _t2 : [1, 1, 1, 1]
    # _t2w1 : [1, 1, 1, 1]
    ...
    min_act_thrt = 0.25 #minimum nilai suatu throttle dianggap aktif diinjak
